    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertisementsAppUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdvertisementsAppUser_advertisementAppUserStatuses_AdvertisementAppUserStatusId",
                        column: x => x.AdvertisementAppUserStatusId,
                        principalTable: "advertisementAppUserStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdvertisementsAppUser_Advertisements_AdvertisementId",
                        column: x => x.AdvertisementId,
                        principalTable: "Advertisements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdvertisementsAppUser_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdvertisementsAppUser_MilitaryStatuses_MilitaryStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementsAppUser_AdvertisementAppUserStatusId",
                table: "AdvertisementsAppUser",
                column: "AdvertisementAppUserStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementsAppUser_AdvertisementId_AppUserId",
                table: "AdvertisementsAppUser",
                columns: new[] { "AdvertisementId", "AppUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementsAppUser_AppUserId",
                table: "AdvertisementsAppUser",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementsAppUser_MilitaryStatusId",
                table: "AdvertisementsAppUser",
